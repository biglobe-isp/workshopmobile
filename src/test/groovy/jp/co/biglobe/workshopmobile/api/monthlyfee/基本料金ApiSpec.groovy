...
import static jp.co.biglobe.workshopmobile.api.monthlyfee.基本料金ApiSpec.ありなし.あり
import static jp.co.biglobe.workshopmobile.api.monthlyfee.基本料金ApiSpec.ありなし.なし
...
@Unroll
@WebMvcTest
class 基本料金ApiSpec extends Specification {
    @Autowired
    MockMvc mvc
